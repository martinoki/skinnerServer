...
public class ScheduledTasks {
	...
	public void reportPorClima() {
		...
		List<String> heatList = new ArrayList<String>(Arrays.asList(
				"Utilice ropa ligera y clara que cubra la mayor parte del cuerpo para evitar la acci�n directa del sol",
				"No olvide protecci�n solar, sombrero y gafas",
				"No olvide protecci�n solar, sombrero y gafas",
				"No olvide protecci�n solar, sombrero y gafas",
				"Tome agua para que tanto usted como su piel est�n hidratados",
				"Tome agua para que tanto usted como su piel est�n hidratados",				
				"Tome agua para que tanto usted como su piel est�n hidratados",				
				"Intentar evitar la luz del sol desde las 10 de la ma�ana hasta las 17 horas, ya que en ese horario los rayos son m�s fuertes",
				"Intentar evitar la luz del sol desde las 10 de la ma�ana hasta las 17 horas, ya que en ese horario los rayos son m�s fuertes",
				"Intentar evitar la luz del sol desde las 10 de la ma�ana hasta las 17 horas, ya que en ese horario los rayos son m�s fuertes"
				));
		List<String> coldList = new ArrayList<String>(Arrays.asList(
			"Prot�jase con ropa comoda y no abrasiva ya que puede ser peligroso para la piel",
			"Si va a estar durante periodos prolongados afuera, utilice protector de Factor 15 o superior",
			"Proteja sus labios y mant�ngalos humectados ante bajas temperaturas",
			"Mantenga la piel hidratada ante temperaturas bajas",
			"Intente evitar la luz del sol desde las 10 de la ma�ana hasta las 17 horas, ya que en ese horario los rayos son m�s fuertes"
		));
		List<String> windList = new ArrayList<String>(Arrays.asList("En d�as de mucho viento, procure proteger la zona afectada utilizando anteojos, mangas largas y gorro o sombrero ya que el viento puede reducir la protecci�n de la piel contra la luz solar"));
