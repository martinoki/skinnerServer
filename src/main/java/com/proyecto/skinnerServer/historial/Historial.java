...
public class Historial {
	...
	@PutMapping("/historial/{id}")
		public Map<String,Object> editHistorial(@RequestBody Map<String,Object> historialData, @PathVariable("id") long id){
			String sql = "UPDATE historial_lesion SET id_doctor = %d, analisis = '%s' WHERE id = %d RETURNING *";
			sql = String.format(sql, historialData.get("id_doctor"),  historialData.get("analisis"), id);
